...
import (
	...
	v1alpha1 "mypetstore/gen/proto/gogo/payment/v1alpha1"
	reflect "reflect"
	sync "sync"
)
...
var file_pet_v1_pet_proto_rawDesc = []byte{
	...
	0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x22, 0x5a, 0x0a, 0x12, 0x50, 0x75, 0x72, 0x63, 0x68, 0x61,
	...
	0x74, 0x52, 0x65, 0x73, 0x70, 0x6f, 0x6e, 0x73, 0x65, 0x22, 0x92, 0x01, 0x0a, 0x03, 0x50, 0x65,
	...
	0x6d, 0x79, 0x70, 0x65, 0x74, 0x73, 0x74, 0x6f, 0x72, 0x65, 0x2f, 0x67, 0x65, 0x6e, 0x2f, 0x70,
	0x72, 0x6f, 0x74, 0x6f, 0x2f, 0x67, 0x6f, 0x67, 0x6f, 0x2f, 0x70, 0x65, 0x74, 0x2f, 0x76, 0x31,
...
var file_pet_v1_pet_proto_goTypes = []interface{}{
	...
	(*PurchasePetRequest)(nil),  // 1: pet.v1.PurchasePetRequest
	(*PurchasePetResponse)(nil), // 2: pet.v1.PurchasePetResponse
	(*Pet)(nil),                 // 3: pet.v1.Pet
	(*GetPetRequest)(nil),       // 4: pet.v1.GetPetRequest
	(*GetPetResponse)(nil),      // 5: pet.v1.GetPetResponse
	(*PutPetRequest)(nil),       // 6: pet.v1.PutPetRequest
	(*PutPetResponse)(nil),      // 7: pet.v1.PutPetResponse
...
var file_pet_v1_pet_proto_depIdxs = []int32{
	10, // 0: pet.v1.PurchasePetRequest.order:type_name -> payment.v1alpha1.Order
	0,  // 1: pet.v1.Pet.pet_type:type_name -> pet.v1.PetType
	11, // 2: pet.v1.Pet.created_at:type_name -> google.type.DateTime
	3,  // 3: pet.v1.GetPetResponse.pet:type_name -> pet.v1.Pet
	0,  // 4: pet.v1.PutPetRequest.pet_type:type_name -> pet.v1.PetType
	3,  // 5: pet.v1.PutPetResponse.pet:type_name -> pet.v1.Pet
	4,  // 6: pet.v1.PetStoreService.GetPet:input_type -> pet.v1.GetPetRequest
	6,  // 7: pet.v1.PetStoreService.PutPet:input_type -> pet.v1.PutPetRequest
	8,  // 8: pet.v1.PetStoreService.DeletePet:input_type -> pet.v1.DeletePetRequest
	1,  // 9: pet.v1.PetStoreService.PurchasePet:input_type -> pet.v1.PurchasePetRequest
	5,  // 10: pet.v1.PetStoreService.GetPet:output_type -> pet.v1.GetPetResponse
	7,  // 11: pet.v1.PetStoreService.PutPet:output_type -> pet.v1.PutPetResponse
	9,  // 12: pet.v1.PetStoreService.DeletePet:output_type -> pet.v1.DeletePetResponse
	2,  // 13: pet.v1.PetStoreService.PurchasePet:output_type -> pet.v1.PurchasePetResponse
